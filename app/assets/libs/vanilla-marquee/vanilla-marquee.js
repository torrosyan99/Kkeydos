...
export class marquee {
  constructor(s, e) {
    ...
    for (const t in a) {
      let i = h(s, `data-${a[t]}`);
      null !== i && '' !== i && (('true' !== i && 'false' !== i) || (i = Boolean(i)), (e[t] = i));
    }
      ...
      e.duplicated
        ? (u
            ? e.startVisible
              ...
              : (this.h.style.transform = `translateY(${'up' === e.direction ? this.g : -1 * (2 * this.I - e.gap)}px)`)
            : e.startVisible
              ? (this.h.style.transform = 'translateX(0px)')
              : (this.h.style.transform = `translateX(${'left' === e.direction ? this.q : -1 * (2 * this.j - e.gap)}px)`),
  ...
  _(e = !1) {
    ...
    if (h.duplicated) {
      if (1 === this.i) {
        ...
        2 === this.i &&
          ((this.$ = `${this.$}0`), (this.v = this.m(this.$, h.duration / 1e3, 0, 'infinite')));
      this.i++;
    }
    let a = '';
    (e
      ? h.duplicated
        ? (this.i > 2 &&
            (this.h.style.transform = `translateY(${'up' === h.direction ? 0 : -1 * this.I}px)`),
          (a = `translateY(${'up' === h.direction ? -1 * this.I : 0}px)`))
        : h.startVisible
          ? 2 === this.i
            ? ((this.v = this.m(this.$, h.duration / 1e3, h.delayBeforeStart / 1e3)),
              (a = `translateY(${'up' === h.direction ? -1 * this.I : this.g}px)`),
              this.i++)
            : 3 === this.i &&
              ((this.$ = `${this.$}0`),
              ...
              this.S())
          : (this.S(),
            (a = `translateY(${'up' === h.direction ? -1 * this.h.clientHeight : this.g}px)`))
      : h.duplicated
        ? (this.i > 2 &&
            (this.h.style.transform = `translateX(${'left' === h.direction ? 0 : -1 * this.j}px)`),
        ...
        : h.startVisible
          ? 2 === this.i
            ...
            : 3 === this.i &&
              ...
              this.X())
          : (this.X(), (a = `translateX(${'left' === h.direction ? -1 * this.j : this.q}px)`)),
    ...
    else if (t(`marq-wrap-style-${this.C}`).length) t(`marq-wrap-style-${this.C}`)[0].innerHTML = r;
    else {
  ...
  S() {
    this.h.style.transform = `translateY(${'up' === this.l.direction ? this.g : -1 * this.I}px)`;
  }

  X() {
    this.h.style.transform = `translateX(${'left' === this.l.direction ? this.q : -1 * this.j}px)`;
  }
    ...
    if (this.o) {
      ...
      ((this.I = r),
        e.startVisible && !e.duplicated
          ? ((this.H = ((r + h) / parseInt(h)) * this.u), (e.duration = (r / parseInt(h)) * this.u))
      ...
      ((this.q = h),
        (this.j = s),
        e.startVisible && !e.duplicated
          ? ((this.H = ((s + h) / parseInt(h)) * this.u), (e.duration = (s / parseInt(h)) * this.u))
